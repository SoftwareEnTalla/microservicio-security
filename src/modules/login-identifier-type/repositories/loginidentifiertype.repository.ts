...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class LoginIdentifierTypeRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[LoginIdentifierType[], number]> {
      logger.info('Ready to findByField LoginIdentifierType on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of LoginIdentifierType with id:  was finded on repository:', instance);
