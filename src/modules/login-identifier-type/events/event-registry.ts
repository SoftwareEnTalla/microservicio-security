...
import { LoginIdentifierTypeCreatedEvent } from './loginidentifiertypecreated.event';
import { LoginIdentifierTypeUpdatedEvent } from './loginidentifiertypeupdated.event';
import { LoginIdentifierTypeDeletedEvent } from './loginidentifiertypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'login-identifier-type-created': createEventDefinition('login-identifier-type-created', LoginIdentifierTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['login-identifier-type-created']),
  'login-identifier-type-updated': createEventDefinition('login-identifier-type-updated', LoginIdentifierTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['login-identifier-type-updated']),
  'login-identifier-type-deleted': createEventDefinition('login-identifier-type-deleted', LoginIdentifierTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['login-identifier-type-deleted']),
