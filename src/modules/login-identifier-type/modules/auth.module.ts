...
@Module({
  controllers: [LoginIdentifierTypeCommandController],
  providers: [
  ...
  exports: [LoginIdentifierTypeAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthLoginIdentifierTypeModule {}
