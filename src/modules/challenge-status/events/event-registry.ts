...
import { ChallengeStatusCreatedEvent } from './challengestatuscreated.event';
import { ChallengeStatusUpdatedEvent } from './challengestatusupdated.event';
import { ChallengeStatusDeletedEvent } from './challengestatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'challenge-status-created': createEventDefinition('challenge-status-created', ChallengeStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['challenge-status-created']),
  'challenge-status-updated': createEventDefinition('challenge-status-updated', ChallengeStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['challenge-status-updated']),
  'challenge-status-deleted': createEventDefinition('challenge-status-deleted', ChallengeStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['challenge-status-deleted']),
