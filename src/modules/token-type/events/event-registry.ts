...
import { TokenTypeCreatedEvent } from './tokentypecreated.event';
import { TokenTypeUpdatedEvent } from './tokentypeupdated.event';
import { TokenTypeDeletedEvent } from './tokentypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'token-type-created': createEventDefinition('token-type-created', TokenTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['token-type-created']),
  'token-type-updated': createEventDefinition('token-type-updated', TokenTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['token-type-updated']),
  'token-type-deleted': createEventDefinition('token-type-deleted', TokenTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['token-type-deleted']),
