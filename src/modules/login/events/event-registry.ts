...
import { LoginCreatedEvent } from './logincreated.event';
import { LoginUpdatedEvent } from './loginupdated.event';
import { LoginDeletedEvent } from './logindeleted.event';
...
import { LoginLoggedOutEvent } from './loginloggedout.event';
import { FederatedLoginStartedEvent } from './federatedloginstarted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'login-created': createEventDefinition('login-created', LoginCreatedEvent, EVENT_DEFINITION_OVERRIDES['login-created']),
  'login-updated': createEventDefinition('login-updated', LoginUpdatedEvent, EVENT_DEFINITION_OVERRIDES['login-updated']),
  'login-deleted': createEventDefinition('login-deleted', LoginDeletedEvent, EVENT_DEFINITION_OVERRIDES['login-deleted']),
  ...
  'login-logged-out': createEventDefinition('login-logged-out', LoginLoggedOutEvent, EVENT_DEFINITION_OVERRIDES['login-logged-out']),
  'federated-login-started': createEventDefinition('federated-login-started', FederatedLoginStartedEvent, EVENT_DEFINITION_OVERRIDES['federated-login-started']),
};
