...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class SecurityCustomerRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[SecurityCustomer[], number]> {
      logger.info('Ready to findByField SecurityCustomer on repository:',where);
    ...
    client: LoggerClient.getInstance()
      ...
      .get(SecurityCustomerRepository.name),
        ...
        async findOne(options?: Record<string, any>): Promise<SecurityCustomer | null> {
      ...
      if (isFindOneOptions) {
        logger.info('Ready to findOne (FindOneOptions) SecurityCustomer:', options);
        return this.repository.findOne(options as any);
      }
      const tmp: FindOptionsWhere<SecurityCustomer> = options as FindOptionsWhere<SecurityCustomer>;
    ...
    async update(
        ...
        logger.info('Updated instance of SecurityCustomer with id:  was finded on repository:', instance);
