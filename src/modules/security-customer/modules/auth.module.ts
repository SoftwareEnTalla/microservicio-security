...
@Module({
  controllers: [SecurityCustomerCommandController],
  providers: [
  ...
  exports: [SecurityCustomerAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthSecurityCustomerModule {}
