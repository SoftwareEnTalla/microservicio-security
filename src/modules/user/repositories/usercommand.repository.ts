...
export class UserCommandRepository implements IEventHandler<BaseEvent>{
  ...
  async create(entity: User): Promise<User> {
    ...
    if (this.shouldPublishEvent()) {
      const __dualEvt1 = new UserCreatedEvent(result.id, {
        instance: result,
        metadata: {
  ...
  async bulkCreate(entities: User[]): Promise<User[]> {
    ...
    if (this.shouldPublishEvent()) {
      const __dualEvts2 = result.map((el)=>new UserCreatedEvent(el.id, {
        instance: el,
        metadata: {
  ...
  async update(
    ...
    if(instance && this.shouldPublishEvent()) {
      ...
      const __dualEvt3 = new UserUpdatedEvent(instance.id, {
          instance: instance,
          metadata: {
    ...
    for (const entity of entities) {
      if (entity.id) {
        ...
        if (updatedEntity) {
          ...
          if (this.shouldPublishEvent()) {
            const __dualEvt4 = new UserUpdatedEvent(updatedEntity.id, {
  ...
  async delete(id: string): Promise<DeleteResult> {
     ...
     if (this.shouldPublishEvent()) {
       ...
       const __dualEvt5 = new UserDeletedEvent(id, {
        instance: entity,
        metadata: {
