...
import { logger } from '@core/logs/logger';
  ...
  export class UserQueryRepository {
    ...
    //Constructor del repositorio de datos: UserQueryRepository
    constructor(
    ...
    async findWithPagination(
      ...
      logger.info('Ready to findWithPagination User on repository:', options);
      return this.repository.find(options);
    }
    ...
    async findAndCount(where?: Record<string, any>): Promise<[User[], number]> {
      logger.info('Ready to findAndCount User on repository:',where);
      let result= this.repository.findAndCount({
        where: where,
      });
      logger.info('Was counted  instances of User on repository:',result);
      return result;
    }
    ...
    async findOne(where?: Record<string, any>): Promise<User | null> {
      const tmp: FindOptionsWhere<User> = where as FindOptionsWhere<User>;
      logger.info('Ready to findOneBy User on repository with conditions:', tmp);
