...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'user-created': createEventDefinition('user-created', UserCreatedEvent, EVENT_DEFINITION_OVERRIDES['user-created']),
  'user-updated': createEventDefinition('user-updated', UserUpdatedEvent, EVENT_DEFINITION_OVERRIDES['user-updated']),
  'user-deleted': createEventDefinition('user-deleted', UserDeletedEvent, EVENT_DEFINITION_OVERRIDES['user-deleted']),
