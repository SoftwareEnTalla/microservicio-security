...
import { GetUserByFieldQuery } from '../getuserbyfield.query';
import { UserQueryService } from '../../services/userquery.service';

@QueryHandler(GetUserByFieldQuery)
export class GetUserByFieldHandler implements IQueryHandler<GetUserByFieldQuery> {
  constructor(private readonly queryService: UserQueryService) {}

  async execute(query: GetUserByFieldQuery) {
