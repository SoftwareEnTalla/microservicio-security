...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class SystemAdminPolicyDecisionQueryRepository {

    //Constructor del repositorio de datos: SystemAdminPolicyDecisionQueryRepository
    constructor(
    ...
    async findWithPagination(
      ...
      logger.info('Ready to findWithPagination SystemAdminPolicyDecision on repository:', options);
      return this.repository.find(options);
    }
    ...
    async findAndCount(where?: Record<string, any>): Promise<[SystemAdminPolicyDecision[], number]> {
      logger.info('Ready to findAndCount SystemAdminPolicyDecision on repository:',where);
      let result= this.repository.findAndCount({
        where: where,
      });
      logger.info('Was counted  instances of SystemAdminPolicyDecision on repository:',result);
      return result;
    }
