...
@Module({
  controllers: [SystemAdminPolicyDecisionCommandController],
  providers: [
  ...
  exports: [SystemAdminPolicyDecisionAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthSystemAdminPolicyDecisionModule {}
