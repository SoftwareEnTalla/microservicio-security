...
import { SystemAdminPolicyDecisionCreatedEvent } from './systemadminpolicydecisioncreated.event';
import { SystemAdminPolicyDecisionUpdatedEvent } from './systemadminpolicydecisionupdated.event';
import { SystemAdminPolicyDecisionDeletedEvent } from './systemadminpolicydecisiondeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'system-admin-policy-decision-created': createEventDefinition('system-admin-policy-decision-created', SystemAdminPolicyDecisionCreatedEvent, EVENT_DEFINITION_OVERRIDES['system-admin-policy-decision-created']),
  'system-admin-policy-decision-updated': createEventDefinition('system-admin-policy-decision-updated', SystemAdminPolicyDecisionUpdatedEvent, EVENT_DEFINITION_OVERRIDES['system-admin-policy-decision-updated']),
  'system-admin-policy-decision-deleted': createEventDefinition('system-admin-policy-decision-deleted', SystemAdminPolicyDecisionDeletedEvent, EVENT_DEFINITION_OVERRIDES['system-admin-policy-decision-deleted']),
