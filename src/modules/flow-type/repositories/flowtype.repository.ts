...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class FlowTypeRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[FlowType[], number]> {
      logger.info('Ready to findByField FlowType on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of FlowType with id:  was finded on repository:', instance);
