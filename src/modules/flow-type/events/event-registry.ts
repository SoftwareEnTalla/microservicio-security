...
import { FlowTypeCreatedEvent } from './flowtypecreated.event';
import { FlowTypeUpdatedEvent } from './flowtypeupdated.event';
import { FlowTypeDeletedEvent } from './flowtypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'flow-type-created': createEventDefinition('flow-type-created', FlowTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['flow-type-created']),
  'flow-type-updated': createEventDefinition('flow-type-updated', FlowTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['flow-type-updated']),
  'flow-type-deleted': createEventDefinition('flow-type-deleted', FlowTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['flow-type-deleted']),
