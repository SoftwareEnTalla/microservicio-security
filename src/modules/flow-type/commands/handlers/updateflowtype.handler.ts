...
import { UpdateFlowTypeCommand } from "../updateflowtype.command";
import { FlowTypeCommandService } from "../../services/flowtypecommand.service";

@CommandHandler(UpdateFlowTypeCommand)
export class UpdateFlowTypeHandler
  implements ICommandHandler<UpdateFlowTypeCommand>
{
  constructor(
    private readonly commandService: FlowTypeCommandService
  ) {}
  async execute(command: UpdateFlowTypeCommand) {
