...
@Module({
  controllers: [CatalogSyncLogCommandController],
  providers: [
  ...
  exports: [CatalogSyncLogAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthCatalogSyncLogModule {}
