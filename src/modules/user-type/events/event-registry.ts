...
import { UserTypeCreatedEvent } from './usertypecreated.event';
import { UserTypeUpdatedEvent } from './usertypeupdated.event';
import { UserTypeDeletedEvent } from './usertypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'user-type-created': createEventDefinition('user-type-created', UserTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['user-type-created']),
  'user-type-updated': createEventDefinition('user-type-updated', UserTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['user-type-updated']),
  'user-type-deleted': createEventDefinition('user-type-deleted', UserTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['user-type-deleted']),
