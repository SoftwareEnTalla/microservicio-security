...
@Module({
  controllers: [CertificationStatusCommandController],
  providers: [
  ...
  exports: [CertificationStatusAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthCertificationStatusModule {}
