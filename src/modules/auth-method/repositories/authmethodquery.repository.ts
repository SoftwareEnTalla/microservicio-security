...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class AuthMethodQueryRepository {

    //Constructor del repositorio de datos: AuthMethodQueryRepository
    constructor(
    ...
    async findWithPagination(
      ...
      logger.info('Ready to findWithPagination AuthMethod on repository:', options);
      return this.repository.find(options);
    }
    ...
    async findAndCount(where?: Record<string, any>): Promise<[AuthMethod[], number]> {
      logger.info('Ready to findAndCount AuthMethod on repository:',where);
      let result= this.repository.findAndCount({
        where: where,
      });
      logger.info('Was counted  instances of AuthMethod on repository:',result);
      return result;
    }
