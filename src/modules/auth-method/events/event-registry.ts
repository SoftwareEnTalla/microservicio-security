...
import { AuthMethodCreatedEvent } from './authmethodcreated.event';
import { AuthMethodUpdatedEvent } from './authmethodupdated.event';
import { AuthMethodDeletedEvent } from './authmethoddeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'auth-method-created': createEventDefinition('auth-method-created', AuthMethodCreatedEvent, EVENT_DEFINITION_OVERRIDES['auth-method-created']),
  'auth-method-updated': createEventDefinition('auth-method-updated', AuthMethodUpdatedEvent, EVENT_DEFINITION_OVERRIDES['auth-method-updated']),
  'auth-method-deleted': createEventDefinition('auth-method-deleted', AuthMethodDeletedEvent, EVENT_DEFINITION_OVERRIDES['auth-method-deleted']),
