...
import { AuthStatusCreatedEvent } from './authstatuscreated.event';
import { AuthStatusUpdatedEvent } from './authstatusupdated.event';
import { AuthStatusDeletedEvent } from './authstatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'auth-status-created': createEventDefinition('auth-status-created', AuthStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['auth-status-created']),
  'auth-status-updated': createEventDefinition('auth-status-updated', AuthStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['auth-status-updated']),
  'auth-status-deleted': createEventDefinition('auth-status-deleted', AuthStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['auth-status-deleted']),
