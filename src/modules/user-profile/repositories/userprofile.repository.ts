...
import { logger } from '@core/logs/logger';
  ...
  export class UserProfileRepository {
    ...
    async findAndCount(where?: Record<string, any>): Promise<[UserProfile[], number]> {
      logger.info('Ready to findByField UserProfile on repository:',where);
    ...
    client: LoggerClient.getInstance()
      ...
      .get(UserProfileRepository.name),
        ...
        async findOne(options?: Record<string, any>): Promise<UserProfile | null> {
      ...
      if (isFindOneOptions) {
        logger.info('Ready to findOne (FindOneOptions) UserProfile:', options);
        return this.repository.findOne(options as any);
      }
      const tmp: FindOptionsWhere<UserProfile> = options as FindOptionsWhere<UserProfile>;
    ...
    async update(
        ...
        logger.info('Updated instance of UserProfile with id:  was finded on repository:', instance);
