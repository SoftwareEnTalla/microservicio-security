...
import { UserProfileCreatedEvent } from './userprofilecreated.event';
import { UserProfileUpdatedEvent } from './userprofileupdated.event';
import { UserProfileDeletedEvent } from './userprofiledeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'user-profile-created': createEventDefinition('user-profile-created', UserProfileCreatedEvent, EVENT_DEFINITION_OVERRIDES['user-profile-created']),
  'user-profile-updated': createEventDefinition('user-profile-updated', UserProfileUpdatedEvent, EVENT_DEFINITION_OVERRIDES['user-profile-updated']),
  'user-profile-deleted': createEventDefinition('user-profile-deleted', UserProfileDeletedEvent, EVENT_DEFINITION_OVERRIDES['user-profile-deleted']),
