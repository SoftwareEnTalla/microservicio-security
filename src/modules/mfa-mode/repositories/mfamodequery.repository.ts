...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class MfaModeQueryRepository {

    //Constructor del repositorio de datos: MfaModeQueryRepository
    constructor(
    ...
    async findWithPagination(
      ...
      logger.info('Ready to findWithPagination MfaMode on repository:', options);
      return this.repository.find(options);
    }
    ...
    async findAndCount(where?: Record<string, any>): Promise<[MfaMode[], number]> {
      logger.info('Ready to findAndCount MfaMode on repository:',where);
      let result= this.repository.findAndCount({
        where: where,
      });
      logger.info('Was counted  instances of MfaMode on repository:',result);
      return result;
    }
