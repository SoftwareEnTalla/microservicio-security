...
import { MfaModeCreatedEvent } from './mfamodecreated.event';
import { MfaModeUpdatedEvent } from './mfamodeupdated.event';
import { MfaModeDeletedEvent } from './mfamodedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'mfa-mode-created': createEventDefinition('mfa-mode-created', MfaModeCreatedEvent, EVENT_DEFINITION_OVERRIDES['mfa-mode-created']),
  'mfa-mode-updated': createEventDefinition('mfa-mode-updated', MfaModeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['mfa-mode-updated']),
  'mfa-mode-deleted': createEventDefinition('mfa-mode-deleted', MfaModeDeletedEvent, EVENT_DEFINITION_OVERRIDES['mfa-mode-deleted']),
