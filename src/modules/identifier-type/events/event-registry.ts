...
import { IdentifierTypeCreatedEvent } from './identifiertypecreated.event';
import { IdentifierTypeUpdatedEvent } from './identifiertypeupdated.event';
import { IdentifierTypeDeletedEvent } from './identifiertypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'identifier-type-created': createEventDefinition('identifier-type-created', IdentifierTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['identifier-type-created']),
  'identifier-type-updated': createEventDefinition('identifier-type-updated', IdentifierTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['identifier-type-updated']),
  'identifier-type-deleted': createEventDefinition('identifier-type-deleted', IdentifierTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['identifier-type-deleted']),
