...
@Module({
  controllers: [IdentifierTypeCommandController],
  providers: [
  ...
  exports: [IdentifierTypeAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthIdentifierTypeModule {}
