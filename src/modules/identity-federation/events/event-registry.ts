...
import { IdentityFederationCreatedEvent } from './identityfederationcreated.event';
import { IdentityFederationUpdatedEvent } from './identityfederationupdated.event';
import { IdentityFederationDeletedEvent } from './identityfederationdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'identity-federation-created': createEventDefinition('identity-federation-created', IdentityFederationCreatedEvent, EVENT_DEFINITION_OVERRIDES['identity-federation-created']),
  'identity-federation-updated': createEventDefinition('identity-federation-updated', IdentityFederationUpdatedEvent, EVENT_DEFINITION_OVERRIDES['identity-federation-updated']),
  'identity-federation-deleted': createEventDefinition('identity-federation-deleted', IdentityFederationDeletedEvent, EVENT_DEFINITION_OVERRIDES['identity-federation-deleted']),
