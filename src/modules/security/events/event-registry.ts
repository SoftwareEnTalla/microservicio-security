...
import { SecurityCreatedEvent } from './securitycreated.event';
import { SecurityUpdatedEvent } from './securityupdated.event';
import { SecurityDeletedEvent } from './securitydeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'security-created': createEventDefinition('security-created', SecurityCreatedEvent, EVENT_DEFINITION_OVERRIDES['security-created']),
  'security-updated': createEventDefinition('security-updated', SecurityUpdatedEvent, EVENT_DEFINITION_OVERRIDES['security-updated']),
  'security-deleted': createEventDefinition('security-deleted', SecurityDeletedEvent, EVENT_DEFINITION_OVERRIDES['security-deleted']),
