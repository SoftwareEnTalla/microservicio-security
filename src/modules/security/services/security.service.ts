...
export class SecurityService {
  ...
  // Métodos delegados
  async findAll(options?: any): Promise<Security[]> {
  ...
  async findByField(field: string, value: any, page: number, limit: number): Promise<Security[]> {
    return this.repository.findByField(field, value, page, limit);
  }

  async findWithPagination(options: any, page: number, limit: number): Promise<Security[]> {
  ...
  async update(id: string, partialEntity: Partial<Security>): Promise<Security | null> {
