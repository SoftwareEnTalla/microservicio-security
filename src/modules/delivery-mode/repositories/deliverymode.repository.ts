...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class DeliveryModeRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[DeliveryMode[], number]> {
      logger.info('Ready to findByField DeliveryMode on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of DeliveryMode with id:  was finded on repository:', instance);
