...
import { DeliveryModeCreatedEvent } from './deliverymodecreated.event';
import { DeliveryModeUpdatedEvent } from './deliverymodeupdated.event';
import { DeliveryModeDeletedEvent } from './deliverymodedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'delivery-mode-created': createEventDefinition('delivery-mode-created', DeliveryModeCreatedEvent, EVENT_DEFINITION_OVERRIDES['delivery-mode-created']),
  'delivery-mode-updated': createEventDefinition('delivery-mode-updated', DeliveryModeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['delivery-mode-updated']),
  'delivery-mode-deleted': createEventDefinition('delivery-mode-deleted', DeliveryModeDeletedEvent, EVENT_DEFINITION_OVERRIDES['delivery-mode-deleted']),
