...
import { ProtocolFamilyCreatedEvent } from './protocolfamilycreated.event';
import { ProtocolFamilyUpdatedEvent } from './protocolfamilyupdated.event';
import { ProtocolFamilyDeletedEvent } from './protocolfamilydeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'protocol-family-created': createEventDefinition('protocol-family-created', ProtocolFamilyCreatedEvent, EVENT_DEFINITION_OVERRIDES['protocol-family-created']),
  'protocol-family-updated': createEventDefinition('protocol-family-updated', ProtocolFamilyUpdatedEvent, EVENT_DEFINITION_OVERRIDES['protocol-family-updated']),
  'protocol-family-deleted': createEventDefinition('protocol-family-deleted', ProtocolFamilyDeletedEvent, EVENT_DEFINITION_OVERRIDES['protocol-family-deleted']),
