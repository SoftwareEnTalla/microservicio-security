...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class SecurityMasterDataRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[SecurityMasterData[], number]> {
      logger.info('Ready to findByField SecurityMasterData on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of SecurityMasterData with id:  was finded on repository:', instance);
