...
export class SecurityMasterDataCommandRepository implements IEventHandler<BaseEvent>{
  ...
  async create(entity: SecurityMasterData): Promise<SecurityMasterData> {
    ...
    if (this.shouldPublishEvent()) {
      const __dualEvt1 = new SecurityMasterDataCreatedEvent(result.id, {
        instance: result,
        metadata: {
  ...
  async bulkCreate(entities: SecurityMasterData[]): Promise<SecurityMasterData[]> {
    ...
    if (this.shouldPublishEvent()) {
      const __dualEvts2 = result.map((el)=>new SecurityMasterDataCreatedEvent(el.id, {
        instance: el,
        metadata: {
  ...
  async update(
    ...
    if(instance && this.shouldPublishEvent()) {
      ...
      const __dualEvt3 = new SecurityMasterDataUpdatedEvent(instance.id, {
          instance: instance,
          metadata: {
    ...
    for (const entity of entities) {
      if (entity.id) {
        ...
        if (updatedEntity) {
          ...
          if (this.shouldPublishEvent()) {
            const __dualEvt4 = new SecurityMasterDataUpdatedEvent(updatedEntity.id, {
  ...
  async delete(id: string): Promise<DeleteResult> {
     ...
     if (this.shouldPublishEvent()) {
       ...
       const __dualEvt5 = new SecurityMasterDataDeletedEvent(id, {
        instance: entity,
        metadata: {
