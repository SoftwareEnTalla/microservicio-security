...
import { SecurityMasterDataCreatedEvent } from './securitymasterdatacreated.event';
import { SecurityMasterDataUpdatedEvent } from './securitymasterdataupdated.event';
import { SecurityMasterDataDeletedEvent } from './securitymasterdatadeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'security-master-data-created': createEventDefinition('security-master-data-created', SecurityMasterDataCreatedEvent, EVENT_DEFINITION_OVERRIDES['security-master-data-created']),
  'security-master-data-updated': createEventDefinition('security-master-data-updated', SecurityMasterDataUpdatedEvent, EVENT_DEFINITION_OVERRIDES['security-master-data-updated']),
  'security-master-data-deleted': createEventDefinition('security-master-data-deleted', SecurityMasterDataDeletedEvent, EVENT_DEFINITION_OVERRIDES['security-master-data-deleted']),
