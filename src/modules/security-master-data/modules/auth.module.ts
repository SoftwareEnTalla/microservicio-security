...
@Module({
  controllers: [SecurityMasterDataCommandController],
  providers: [
  ...
  exports: [SecurityMasterDataAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthSecurityMasterDataModule {}
