...
import { ChallengeTypeCreatedEvent } from './challengetypecreated.event';
import { ChallengeTypeUpdatedEvent } from './challengetypeupdated.event';
import { ChallengeTypeDeletedEvent } from './challengetypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'challenge-type-created': createEventDefinition('challenge-type-created', ChallengeTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['challenge-type-created']),
  'challenge-type-updated': createEventDefinition('challenge-type-updated', ChallengeTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['challenge-type-updated']),
  'challenge-type-deleted': createEventDefinition('challenge-type-deleted', ChallengeTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['challenge-type-deleted']),
