...
@Module({
  controllers: [ChallengeTypeCommandController],
  providers: [
  ...
  exports: [ChallengeTypeAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthChallengeTypeModule {}
