...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class RbacAclRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[RbacAcl[], number]> {
      logger.info('Ready to findByField RbacAcl on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of RbacAcl with id:  was finded on repository:', instance);
