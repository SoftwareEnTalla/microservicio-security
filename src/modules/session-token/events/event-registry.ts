...
import { SessionTokenCreatedEvent } from './sessiontokencreated.event';
import { SessionTokenUpdatedEvent } from './sessiontokenupdated.event';
import { SessionTokenDeletedEvent } from './sessiontokendeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'session-token-created': createEventDefinition('session-token-created', SessionTokenCreatedEvent, EVENT_DEFINITION_OVERRIDES['session-token-created']),
  'session-token-updated': createEventDefinition('session-token-updated', SessionTokenUpdatedEvent, EVENT_DEFINITION_OVERRIDES['session-token-updated']),
  'session-token-deleted': createEventDefinition('session-token-deleted', SessionTokenDeletedEvent, EVENT_DEFINITION_OVERRIDES['session-token-deleted']),
