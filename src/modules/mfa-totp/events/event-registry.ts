...
import { MfaTotpCreatedEvent } from './mfatotpcreated.event';
import { MfaTotpUpdatedEvent } from './mfatotpupdated.event';
import { MfaTotpDeletedEvent } from './mfatotpdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'mfa-totp-created': createEventDefinition('mfa-totp-created', MfaTotpCreatedEvent, EVENT_DEFINITION_OVERRIDES['mfa-totp-created']),
  'mfa-totp-updated': createEventDefinition('mfa-totp-updated', MfaTotpUpdatedEvent, EVENT_DEFINITION_OVERRIDES['mfa-totp-updated']),
  'mfa-totp-deleted': createEventDefinition('mfa-totp-deleted', MfaTotpDeletedEvent, EVENT_DEFINITION_OVERRIDES['mfa-totp-deleted']),
