...
import { logger } from '@core/logs/logger';
  ...
  export class AuthenticationRepository {
    ...
    async findAndCount(where?: Record<string, any>): Promise<[Authentication[], number]> {
      logger.info('Ready to findByField Authentication on repository:',where);
    ...
    client: LoggerClient.getInstance()
      ...
      .get(AuthenticationRepository.name),
        ...
        async findOne(options?: Record<string, any>): Promise<Authentication | null> {
      ...
      if (isFindOneOptions) {
        logger.info('Ready to findOne (FindOneOptions) Authentication:', options);
        return this.repository.findOne(options as any);
      }
      const tmp: FindOptionsWhere<Authentication> = options as FindOptionsWhere<Authentication>;
    ...
    async update(
        ...
        logger.info('Updated instance of Authentication with id:  was finded on repository:', instance);
