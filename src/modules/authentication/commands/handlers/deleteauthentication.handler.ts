...
import { DeleteAuthenticationCommand } from "../deleteauthentication.command";
...
export class DeleteAuthenticationHandler
  implements ICommandHandler<DeleteAuthenticationCommand>
{
  constructor(
