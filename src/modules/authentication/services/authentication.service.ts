...
export class AuthenticationService {
  ...
  // Métodos delegados
  async findAll(options?: any): Promise<Authentication[]> {
  ...
  async findByField(field: string, value: any, page: number, limit: number): Promise<Authentication[]> {
    return this.repository.findByField(field, value, page, limit);
  }

  async findWithPagination(options: any, page: number, limit: number): Promise<Authentication[]> {
  ...
  async update(id: string, partialEntity: Partial<Authentication>): Promise<Authentication | null> {
