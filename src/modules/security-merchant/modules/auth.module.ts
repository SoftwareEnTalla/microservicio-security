...
@Module({
  controllers: [SecurityMerchantCommandController],
  providers: [
  ...
  exports: [SecurityMerchantAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthSecurityMerchantModule {}
