...
import { logger } from '@core/logs/logger';
  ...
  export class ProviderTypeRepository {
    ...
    async findAndCount(where?: Record<string, any>): Promise<[ProviderType[], number]> {
      logger.info('Ready to findByField ProviderType on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of ProviderType with id:  was finded on repository:', instance);
