...
import { ProviderTypeCreatedEvent } from './providertypecreated.event';
import { ProviderTypeUpdatedEvent } from './providertypeupdated.event';
import { ProviderTypeDeletedEvent } from './providertypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'provider-type-created': createEventDefinition('provider-type-created', ProviderTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['provider-type-created']),
  'provider-type-updated': createEventDefinition('provider-type-updated', ProviderTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['provider-type-updated']),
  'provider-type-deleted': createEventDefinition('provider-type-deleted', ProviderTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['provider-type-deleted']),
