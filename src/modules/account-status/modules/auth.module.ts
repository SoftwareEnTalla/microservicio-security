...
@Module({
  controllers: [AccountStatusCommandController],
  providers: [
  ...
  exports: [AccountStatusAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthAccountStatusModule {}
