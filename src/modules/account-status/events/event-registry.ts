...
import { AccountStatusCreatedEvent } from './accountstatuscreated.event';
import { AccountStatusUpdatedEvent } from './accountstatusupdated.event';
import { AccountStatusDeletedEvent } from './accountstatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'account-status-created': createEventDefinition('account-status-created', AccountStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['account-status-created']),
  'account-status-updated': createEventDefinition('account-status-updated', AccountStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['account-status-updated']),
  'account-status-deleted': createEventDefinition('account-status-deleted', AccountStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['account-status-deleted']),
